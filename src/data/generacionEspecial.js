...
export const generacionEspecial = [
  ...
  },
  {
    ...
    name: "Oculin",
    types: ["bug"],
    imageUrl: "/img-special/1115.png",
    stats: { hp: 55, attack: 45, defense: 40, 'special-attack': 50, 'special-defense': 50, speed: 60 },
    height: 5,
    weight: 38,
    description: "Oculin es un Pokémon de cuerpo blando y ojos elevados que le permiten observar en todas direcciones sin moverse. Es extremadamente curioso y suele acercarse a entrenadores para inspeccionarlos. Sus patas pequeñas le permiten desplazarse con saltos cortos, y su lengua rosada se usa para atrapar pequeños insectos..",
    evolutionLine: [{id: 1115, name: "Oculin", sprite: "/img-special/1115.png"},
                    {id: 1116, name: "Viscoptero", sprite: "/img-special/1116.png",details:{trigger:{name:'level-up'}, min_level: 20 }}
    ],
  },
  {
    id: 1116,
    name: "Viscoptero",
    types: ["bug","flying"],
    imageUrl: "/img-special/1116.png",
    stats: { hp: 80, attack: 95, defense: 70, 'special-attack': 70, 'special-defense': 75, speed: 90 },
    height: 12,
    weight: 220,
    description: "Una criatura que ha desarrollado alas translúcidas y garras afiladas. Sus ojos siguen siendo su principal herramienta de vigilancia, capaces de detectar movimientos a kilómetros de distancia. Se le conoce por patrullar bosques desde el aire, cazando intrusos con precisión quirúrgica.",
    evolutionLine: [{id: 1115, name: "Oculin", sprite: "/img-special/1115.png"},
                    {id: 1116, name: "Viscoptero", sprite: "/img-special/1116.png",details:{trigger:{name:'level-up'}, min_level: 20 }}
    ],
  },
  {
    ...
    name: "Garrasin",
    types: ["dark","fighting"],
    imageUrl: "/img-special/1117.png",
    stats: { hp: 85, attack: 115, defense: 80, 'special-attack': 60, 'special-defense': 70, speed: 90 },
    height: 14,
    weight: 420,
    description: "Garrasin es un Pokémon impulsivo que se alimenta de la adrenalina del combate. Sus garras pueden desgarrar acero, y su sonrisa intimidante paraliza a sus oponentes antes de atacar. Se le encuentra en zonas volcánicas y cavernas profundas, donde entrena golpeando rocas hasta pulverizarlas. Su cabello puntiagudo vibra cuando detecta emociones intensas.",
    evolutionLine: [{id: 1117, name: "Garrasin", sprite: "/img-special/1117.png"}
    ],
  },
  {
    id: 1118,
    name: "Dracelux",
    types: ["dragon"],
    imageUrl: "/img-special/1118.png",
    stats: { hp: 55, attack: 65, defense: 50, 'special-attack': 70, 'special-defense': 55, speed: 70 },
    height: 9,
    weight: 280,
    description: "Dracelux es un Pokémon joven que acumula energía en sus marcas lumínicas. Aunque aún no domina el vuelo, puede generar descargas eléctricas al correr. Su cuerpo brilla en la oscuridad, lo que lo hace fácil de detectar pero difícil de atrapar.",
    evolutionLine: [{id: 1118, name: "Dracelux", sprite: "/img-special/1118.png"},
                    {id: 1119, name: "Voltgon", sprite: "/img-special/1119.png",details:{trigger:{name:'level-up'}, min_level: 25 }},
                    {id: 1120, name: "Dravoltus", sprite: "/img-special/1120.png",details:{trigger:{name:'level-up'}, min_level: 45 }}
    ],
  },
  {
    id: 1119,
    name: "Voltgon",
    types: ["dragon","flying"],
    imageUrl: "/img-special/1119.png",
    stats: { hp: 80, attack: 90, defense: 75, 'special-attack': 100, 'special-defense': 80, speed: 90 },
    height: 16,
    weight: 680,
    description: "Voltgon ha desarrollado alas cargadas con energía estática que le permiten volar a gran velocidad. Sus garras pueden canalizar rayos, y su rugido genera ondas electromagnéticas que interfieren con dispositivos electrónicos. Se le considera un guardián de tormentas.",
    evolutionLine: [{id: 1118, name: "Dracelux", sprite: "/img-special/1118.png"},
                    {id: 1119, name: "Voltgon", sprite: "/img-special/1119.png",details:{trigger:{name:'level-up'}, min_level: 25 }},
                    {id: 1120, name: "Dravoltus", sprite: "/img-special/1120.png",details:{trigger:{name:'level-up'}, min_level: 45 }}
    ],
  },
  {
    ...
    imageUrl: "/img-special/1120.png",
    stats: { hp: 100, attack: 120, defense: 90, 'special-attack': 115, 'special-defense': 85, speed: 100 },
    height: 23,
    weight: 1120,
    description: "Una criatura que ha dominado la energía del cielo. Sus patrones brillan con intensidad cuando se prepara para atacar, y su aliento puede generar tormentas eléctricas en segundos. Se dice que su vuelo deja una estela de luz que puede verse desde kilómetros de distancia.",
    evolutionLine: [{id: 1118, name: "Dracelux", sprite: "/img-special/1118.png"},
                    {id: 1119, name: "Voltgon", sprite: "/img-special/1119.png",details:{trigger:{name:'level-up'}, min_level: 25 }},
                    {id: 1120, name: "Dravoltus", sprite: "/img-special/1120.png",details:{trigger:{name:'level-up'}, min_level: 45 }}
    ],
