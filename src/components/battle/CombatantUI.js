...
const STATUS_CONFIG = {
    poisoned:  { label: 'VEN', className: 'status-poisoned' },
    paralyzed: { label: 'PAR', className: 'status-paralyzed' },
...
export const CombatantUI = React.memo(function CombatantUI({
    ...
    const statusConfig = pokemon.status ? STATUS_CONFIG[pokemon.status] : null;
