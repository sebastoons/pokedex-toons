    ...
    return (
      <div className="pokedex-container">
          ...
          <Routes location={location} key={location.pathname}>
              ...
              <Route path="/battle" element={<motion.div variants={pageVariants} initial="initial" animate="animate" exit="exit"><BattleModeSelector pokemonList={pokemonList} /></motion.div>} />
